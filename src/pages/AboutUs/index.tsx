      ...
      <div className="tw-flex tw-justify-around tw-h-[25rem]">
        ...
        <div className="tw-flex tw-bg-white tw-w-1/2 tw-items-center tw-justify-center">
          <div className="tw-w-3/4 tw-font-bold">
            ...
            solution for mental health support among all of us. Taking into
            account this problem, our team created this platform. It's enought
            to prompt your problem into our search bar, and the most relevant
            specialist will be found and easily booked for your first free
            session!
          </div>
        </div>
      ...
      <div className="tw-flex tw-justify-around tw-h-[15rem]">
        ...
        <div className="tw-flex tw-bg-purple tw-w-1/2 tw-rounded-tl-lg tw-items-center tw-justify-center">
          <div className="tw-w-3/4 tw-font-bold tw-text-white">
            Our mission is to create a substantial mental health support for all
            generations breaking social stereotypes and taboos. We believe that
            making an access to help easier, we increase the number of people
            asking for help in case of such circumstances.
          </div>
        </div>
      </div>
    </div>
